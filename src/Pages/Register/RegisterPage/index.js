    ...
    <div id="register-page">
      <div className="register-page__header">
        <div className="register-page__header-shopee">
          <a href="/" className="register-page__header-shopee__link">
        ...
        <a
          ...
          className="register-page__header-need-help-btn"
        >
          Cần trợ giúp?
        </a>
      </div>
          ...
          <form className="register-page__content-form">
            ...
            <div className="register-page__content-form__part">
              ...
              <div className="register-page__content-form__ask-for-login">
                ...
                <button className="register-page__content-form__ask-for-login__login-btn">
                  Đăng nhập
                </button>
              </div>
            </div>
      ...
      <div className="register-page__confirmation">
        <div className="register-page__confirmation-part">
          ...
          <form action="" className="register-page__confirmation__first-form">
            <div className="register-page__confirmation__first-form__header">
              <button className="register-page__confirmation__first-form__header__back-btn">
            ...
            <div className="register-page__confirmation__first-form__content">
              <div className="register-page__confirmation__first-form__content__notify-error">
                ...
                <span className="register-page__confirmation__first-form__content__notify-error__text">
              ...
              <div className="register-page__confirmation__first-form__content__user-phone-number"></div>
              <input
              ...
              <button className="register-page__confirmation__first-form__content__confirm-btn">
                XÁC NHẬN
              </button>
            </div>
          </form>

          <form action="" className="register-page__confirmation__second-form">
            <div className="register-page__confirmation__second-form__header">
              <button className="register-page__confirmation__second-form__header__back-btn">
                <svg viewBox="0 0 22 17" className="">
                  <g
                    stroke="none"
                    strokeWidth="1"
            ...
            <div className="register-page__confirmation__second-form__content">
              ...
              <button className="register-page__confirmation__second-form__content__register-btn">
                ĐĂNG KÝ
              </button>
            </div>
          </form>

          <form action="" className="register-page__confirmation__third-form">
            ...
            <div className="register-page__confirmation__third-form__content">
              ...
              <div className="register-page__confirmation__third-form__content-second-notify">
                ...
                <div className="register-page__confirmation__third-form__content-second-notify__count-down">
                  <span className="register-page__confirmation__third-form__content-second-notify__seconds-number"></span>{" "}
                  giây
                </div>
              </div>

              <button className="register-page__confirmation__third-form__content-back-to-shopee-btn">
                Quay Lại Shopee
              </button>
            </div>
          </form>
