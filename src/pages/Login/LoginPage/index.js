    ...
    return (
        <div id="login-page">
            <div className="login-page__header">
                <div className="login-page__header-shopee">
                    ...
                    <div className="login-page__header-shopee__text">
                        Đăng nhập
                    </div>
                </div>
                <a
                    ...
                    className="login-page__header-need-help-btn"
                >
                    Cần trợ giúp?
                </a>
            </div>
            ...
            <div className="login-page__content">
                ...
                >
                    <form className="login-page__content-form">
                        <div className="login-page__content-form__heading">
                            Đăng Nhập
                        </div>
                        <div className="login-page__content-form__part">
                            <div className="login-page__content-form__notify-error">
                                <div className="login-page__content-form__notify-error__icon">
                                ...
                                <span className="login-page__content-form__notify-error__text">
                                    Đăng nhập KHÔNG thành công. Bạn vui lòng thử
                                    lại hoặc đăng nhập bằng cách khác nhé!
                                </span>
                            </div>

                            <div className="login-page__content-form__first-input-part">
                                <div className="login-page__content-form__first-input-main">
                                    <input
                                        type="text"
                                        placeholder="Số điện thoại"
                                        autoFocus
                                        className="login-page__content-form__first-input"
                                    />
                                </div>
                                <div className="login-page__content-form__first-input-part--invalid">
                                    Số điện thoại không hợp lệ
                                </div>
                            </div>

                            <div className="login-page__content-form__second-input-part">
                                <div className="login-page__content-form__second-input-main">
                                    <input
                                        className="login-page__content-form__second-input"
                                        ...
                                        autoFocus
                                    />
                                    <button className="login-page__content-form__second-input-status-btn">
                                        <svg
                                            fill="none"
                                            viewBox="0 0 20 12"
                                            className="login-page__content-form__second-input-status-btn__showing"
                                        >
                                            <path
                                                stroke="none"
                                                fill="#000"
                                        ...
                                        <svg
                                            fill="none"
                                            viewBox="0 0 20 10"
                                            className="login-page__content-form__second-input-status-btn__hiding"
                                        >
                                            <path
                                                stroke="none"
                                                fill="#000"
                                ...
                                <div className="login-page__content-form__second-input-part--invalid">
                                    Vui lòng điền chính xác vào mục này
                                </div>
                            </div>

                            <button className="login-page__content-form__login-btn">
                                ĐĂNG NHẬP
                            </button>

                            <div className="login-page__content-form__under-login-btn">
                                <button className="login-page__content-form__under-login-btn__forget-password-btn">
                                    Quên mật khẩu
                                </button>
                                <button className="login-page__content-form__under-login-btn__login-with-sms">
                                    Đăng nhập với SMS
                                </button>
                            </div>

                            <div className="login-page__content-form__separate-part">
                                <div></div>
                                <div className="login-page__content-form__separate-part__text">
                                    HOẶC
                                </div>
                                <div></div>
                            </div>
                            ...
                            <div className="login-page__content-form__ask-for-register">
                                <span className="login-page__content-form__ask-for-register__text">
                                    Bạn mới biết đến Shopee?
                                </span>
                                <Link
                                    to="/register"
                                    className="login-page__content-form__ask-for-register__register-btn"
                                >
                                    Đăng kí
                                </Link>
                            </div>
