...
function App() {
  ...
  //     var loginPageContentFormLoginBtn = $(
  ...
  //     var headerLinksBecomeAShopeeSeller = $(
  ...
  //     var shopeeMallMainProductNextBtn = $(
  ...
  //       }
  //     );
  //     loginPageContentFormUnderLoginBtnLoginWithSMS.addEventListener(
  //       "click",
  //       (e) => {
  //         e.preventDefault();
  //       }
  ...
  //       registerPageConfirmationStepItem.children[0].style.backgroundColor =
  //         "#6c0";
  ...
  //         "rgba(0,0,0,.26)";
  //       registerPageConfirmationStepItem.children[0].style.color =
  //         "rgba(0,0,0,.26)";
  ...
  //         registerPageContentFormInput.value = `(+84) ${currentInputValue.slice(
  //           -9
  //         )}`;
  ...
  //     headerNotificationPopupWhenNotLoginLoginBtn.addEventListener(
  //       "click",
  //       (e) => {
  //         e.preventDefault();
  ...
  //     loginPageContentFormAskForRegisterRegisterBtn.addEventListener(
  //       "click",
  //       (e) => {
  //         e.preventDefault();
  ...
  //           loginPageContentFormSecondInputStatusBtnShowing.style.display =
  //             "block";
  ...
  //           loginPageContentFormSecondInput.value ==
  //             systemConfig.userAccount.password
  //         ) {
  ...
  //             headerSearchHistoryItemLinks.length;
  ...
  //       var aTags =
  //         datas.outstandingHotBrandsInfo.outstandingHotBrandsListInfo.map(
  //           (data) => {
  //             return `
  ...
  //             shopeeMallMainMotionLinkInfo[index].href;
  //           shopeeMallMainMotionImage.src =
  //             shopeeMallMainMotionLinkInfo[index].image;
  ...
  //         .then((datas) => {
  //           var aTags = datas.searchTrendingMainListInfo[listIndex].map(
  //             (data) => {
  //               return `
  ...
  //         for (
  //           var j = 0;
  //           j < todaySuggestionMainTabSuperSale88Info[i].length;
  //           j++
  //         ) {
  //           var frameImage = todaySuggestionMainTabSuperSale88Info[i][j]
  //             .frameImage
  ...
  //             footerTextATags[i].innerHTML =
  //               datas.footerTextATagsInfo[i].innerHTML;
  //           }
  //         });
  //     })();
  //     //#endregion
  ...
  //         21, 11, 6, 18, 11, 15, 21, 10, 8, 8, 8, 11, 10, 8, 13, 6, 15, 6, 10, 10,
  //         9, 10, 5, 6, 11, 6,
  //       ];
  ...
  //         .then((datas) => {
  //           var spanTags = datas.footerPolicyTermsPartCompanyInfoInfo.map(
  //             (data) => {
  ...
  //     motionPartChatPopupMainSearchAndOptionsInput.addEventListener(
  //       "click",
  //       () => {
  ...
  //     motionPartChatPopupMainSearchAndOptionsPart.addEventListener(
  //       "click",
  //       () => {
  //         if (
